...
FIELD DEFINITIONS:
- "style": The aesthetic register for this infographic, chosen from THIS post's topic and energy - and it must genuinely differ from post to post. Pick ONE and name it concretely, for example "clean light flat-vector infographic with an accent colour and soft shadows", "bold editorial data-visualization with real textures", "modern magazine-style layout with photographic touches", or "warm illustrated marketing graphic". Modern, premium, and hand-crafted looking - NO neon glow, NO heavy sci-fi blue, NO circuit-board cliche, and never a bare stock photo or a lone floating object. 3 to 9 words.
...
- "palette": A rich, distinctive colour and light direction for THIS post, named as concrete colours (for example "warm off-white background, deep forest-green accent, charcoal text, soft natural shadows" or "muted sand background, terracotta and navy accents, warm daylight"). Prefer grounded, editorial colour with soft natural light - NO neon, NO glow, and avoid an all-blue tech palette. Every post gets a clearly DIFFERENT palette. At most 30 words, one single-line sentence.
...
- Choose ONE modern, professional aesthetic style and ONE colour-and-light mood for the whole carousel that fit the theme you decided, and commit to both across every slide. Make it contemporary and premium, the way a top human design studio would - clean refined typography, generous spacing, real materials and textures, tasteful iconography, believable depth and soft natural shadows. It must look hand-crafted and editorial, NOT like an AI-generated tech graphic: NO neon glow or glowing outlines, NO heavy sci-fi blue, NO circuit-board or digital-grid cliche. Colour is welcome when the topic suits it, but keep it tasteful and grounded. Name the style once in "style" (concrete and realistic, for example "clean editorial infographic with a warm accent and soft paper texture", "modern flat-design infographic with a confident colour block", or "premium magazine-style layout with real photographic touches"), chosen from the content so it varies from other carousels. Describe the colour mood once in "palette" as concrete colours (for example "warm off-white background, deep forest-green accent, charcoal text, soft natural shadows" or "muted sand background, terracotta and navy accents, warm daylight"), avoiding neon and avoiding an all-blue tech palette.
