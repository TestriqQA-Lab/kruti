...
/**
 * Server-side image edits (sharp) used to remove the LinkedIn "CR"
 ...
 * that embedded manifest, which removes the tag. cropOnePixelBorder() trims 1px
 * off all 4 sides and re-encodes, stripping the manifest so the "CR" tag is gone.
 */
